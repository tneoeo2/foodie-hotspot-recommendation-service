# Generated by Django 4.2.7 on 2023-11-02 16:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_lotno', models.CharField(max_length=200)),
                ('address_roadnm', models.CharField(max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.DecimalField(decimal_places=2, default=0, max_digits=2, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(5.0)])),
